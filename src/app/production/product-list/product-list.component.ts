...
export class ProductListComponent implements OnInit {
  ...
  constructor(private _prodService: ProductionService) {

               }

  ngOnInit(): void {

    this._prodService.refreshNeeded$
    .subscribe(() => {
      this.getAllProducts();
    });
...
onUploadTxtFile() {
  ...
  try {
    ...
    this._prodService.pushFileToStorage(this.currentFileUpload).subscribe(event => {
    ...
    cancelFile() {
     ...
     getAllProducts(){
      ...
      this._prodService.getAllProducts().subscribe(res => {
          this.products = res;
      })
     }
